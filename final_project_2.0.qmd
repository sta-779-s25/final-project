...
```{r, fig.height=9, fig.width=10, fig.cap = "DAG w/ Adjustments"}
...
To capture the time-varying effect of the implementation of Castle Doctrine, we performed G-Computation using the model $Murder_i = CastleDoctrine_i + Years_i + CastleDoctrine_i:Years_i$ and the ATT weighting from our IPW model.
