...
The plots below illustrate how varying strength of an unmeasured confounder's associations with both the exposure (Castle Doctrine) and the outcome (Murder Rate) would bias the estimated effect at one year before and after exposure. The graphs allow us to identify tipping points, where the adjusted treatment effect crosses the null.
